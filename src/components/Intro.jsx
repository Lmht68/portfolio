function Intro() {
    return (
        <div className="flex items-center justify-center flex-col text-center py-40 px-8 content-block-bg">
            ...
            <p className="mt-12 text-sm max-w-3xl font-medium leading-relaxed">
